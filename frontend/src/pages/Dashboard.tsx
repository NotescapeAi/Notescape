...
export default function Dashboard(): JSX.Element {
  ...
  // Doughnut
  const donutData = useMemo<ChartData<"doughnut">>(
    () => ({
      ...
      <main className="flex-1 p-8 overflow-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          ...
          <motion.div
            ...
            className="bg-white rounded-2xl p-5 shadow-sm border border-indigo-50 col-span-2"
          >
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="mt-4">
                  <Link to="/planner" className="text-indigo-600 text-sm font-medium hover:underline">
                    Adjust plan
                  </Link>
                </div>
              </div>
